...
export function IconHoraExtra({ ativo, ...props }) {
  return (
    <IconBtn
      color={ativo ? 'text-emerald-400 hover:text-emerald-300' : 'text-gray-500 hover:text-gray-300'}
      title={ativo ? 'Horas extras liberadas (clique para bloquear)' : 'Liberar horas extras'}
      {...props}
    >
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="12" cy="12" r="10"/>
...
export function IconLiberarData(props) {
  return (
    <IconBtn color="text-purple-400 hover:text-purple-300" title="Banco de horas e liberação por data" {...props}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
